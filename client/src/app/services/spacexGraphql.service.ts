...
export type PastLauchesListQueryVariables = Exact<{
  limit: Scalars['Int'];
}>;


export type PastLauchesListQuery = (
  { __typename?: 'Query' }
...
export const PastLauchesListDocument = gql`
    query pastLauchesList($limit: Int!) {
  ...
  export class PastLauchesListGQL extends Apollo.Query<PastLauchesListQuery, PastLauchesListQueryVariables> {
    document = PastLauchesListDocument;
